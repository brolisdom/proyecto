...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  const containerEl = document.getElementsByClassName('background-event')[0];
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  function CircleTexture({ resolution = 64, color = '#ffffff' }) {
    ...
    canvas.height = resolution * window.devicePixelRatio * 8;
    canvas.width = resolution * window.devicePixelRatio * 8;
